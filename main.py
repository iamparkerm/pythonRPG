...
class Player(Character):
    ...
    def help(self):
        print("Type the first letter of these options: {}.".format(
            Commands.keys()))
...
### 3 main functions: choose player, then kill, or get killed
def player_choice():
    print(
        "Oh, hello, I didn't see you there. You look smart as shit. I bet you're from Owl Town."
        "\nChecking out campus, huh? Did you hear the big rally is today? Are you here to protest?!"
...
def killed_screen():
    print(
        "Your heads feels a little foggy, but you can't think of any response. Maybe you will go home and nap. \nPlease reload the program to play again.")
    sys.exit()
